...
var LogicFlow = /** @class */ (function () {
    function LogicFlow(options) {
        ...
        this.dnd = new behavior_1.Dnd({ lf: this });
        ...
        if (!initOptions.isSilentMode) {
            ...
            (0, keyboard_1.initDefaultShortcut)(this, this.graphModel);
    ...
    LogicFlow.prototype.installPlugins = function (disabledPlugins) {
        ...
        (0, lodash_es_1.forEach)(extensions, function (ext) {
            var extension;
            var props;
            ...
            if ((0, lodash_es_1.indexOf)(disabledPlugins, pluginName) === -1) {
