...
var RectNodeModel = /** @class */ (function (_super) {
    ...
    function RectNodeModel(data, graphModel) {
        ...
        _this.modelType = constant_1.ModelType.RECT_NODE;
        _this.radius = 0;
    ...
    RectNodeModel.prototype.getNodeStyle = function () {
        ...
        return __assign(__assign(__assign({}, style), (0, lodash_es_1.cloneDeep)(rect)), (0, lodash_es_1.cloneDeep)(customStyle));
    };
    __decorate([
        mobx_1.observable
...
exports.RectNodeModel = RectNodeModel;
exports.default = RectNodeModel;
